...
namespace TheFactory_PhoneForm.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        public async Task<ActionResult> addAcount(string username, string password,string name)
        {
            try
            {
                ProfilesViewModels viewmodel = new() { accountName = username, accountPassword = password,employeeName = name };
